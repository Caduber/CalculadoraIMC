...
@.env.3 = private unnamed_addr constant [37 x i8] c"76abb7cf-1304-431d-8d0b-3df26bd4e8d5\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"App.calculadoraIMCdudu\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [31 x i8] c"libaot-ProjetoComercial.dll.so\00", align 1
