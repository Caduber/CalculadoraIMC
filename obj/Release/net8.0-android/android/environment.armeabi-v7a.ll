...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 295755202, ; hash 0x11a0ddc2, from name: ProjetoComercial
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 546272602, ; hash 0x208f755a, from name: aot-ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 56
	...
	%struct.DSOCacheEntry {
		i64 1085202224, ; hash 0x40aedf30, from name: aot-ProjetoComercial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 117
	...
	%struct.DSOCacheEntry {
		i64 1537223950, ; hash 0x5ba02d0e, from name: libaot-ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 1906476290, ; hash 0x71a28502, from name: ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	...
	%struct.DSOCacheEntry {
		i64 4024318347, ; hash 0xefde398b, from name: libaot-ProjetoComercial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
