...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2040437927060015062, ; hash 0x1c51177be4a587d6, from name: ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 46
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4784405796705495048, ; hash 0x42659fb925f36808, from name: libaot-ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 6932891661803674187, ; hash 0x6036943c00135a4b, from name: libaot-ProjetoComercial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 159
	...
	%struct.DSOCacheEntry {
		i64 14870305148578506168, ; hash 0xce5defbf12af25b8, from name: aot-ProjetoComercial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 388
	...
	%struct.DSOCacheEntry {
		i64 15754432777462683752, ; hash 0xdaa2fd23fa6f1868, from name: aot-ProjetoComercial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 18033261391743213442, ; hash 0xfa4303b1049edf82, from name: ProjetoComercial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ProjetoComercial.dll.so
		ptr null; void* handle (0x0)
	}, ; 461
...
@.env.3 = private unnamed_addr constant [37 x i8] c"76abb7cf-1304-431d-8d0b-3df26bd4e8d5\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"App.calculadoraIMCdudu\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [31 x i8] c"libaot-ProjetoComercial.dll.so\00", align 16
